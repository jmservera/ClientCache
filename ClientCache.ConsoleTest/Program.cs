...
namespace ClientCache.ConsoleTest
{
    class Program
    {
        static string[] pictures = new string[]{
            "https://pbs.twimg.com/media/BmKYn4bIIAEoNw_.jpg:large",
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                c.CachePolicy = new System.Net.Cache.RequestCachePolicy(System.Net.Cache.RequestCacheLevel.CacheIfAvailable);
